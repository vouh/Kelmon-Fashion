    ...
    <AppShell activeNav="salon">
      <main className="flex-grow bg-[#faf6fc] dark:bg-background">
        ...
        <section className="px-margin-mobile md:px-margin-desktop pb-16 md:pb-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-7 max-w-[1100px]">
        ...
        <section className="px-margin-mobile md:px-margin-desktop pb-16 md:pb-20">
          <div className="bg-primary text-white p-8 md:p-12 max-w-2xl">
            ...
            <p className="text-white/85 text-sm leading-relaxed mb-6 max-w-md">
              Drop your number and we&apos;ll text you when salon booking goes live.
            </p>
            {joined ? (
